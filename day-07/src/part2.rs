...
impl Hand {
    pub fn new(value: &str) -> Hand {
        ...
        let jokers = *counts.get(&Card::J).unwrap_or(&0);
        let counts: Vec<_> = counts
            .iter()
            .filter(|hand| **hand.0 != Card::J)
            .sorted_by(|a, b| b.1.cmp(a.1))
            .collect();
        let mut hand_type = match counts.len() + jokers {
...
mod tests {
    ...
    #[case("AAAAJ", HandType::FiveOfKind)]
    #[case("JAAJJ", HandType::FiveOfKind)]
    #[case("KTJJT", HandType::FourOfKind)]
